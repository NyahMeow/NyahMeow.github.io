...
async function checkAndLoadData() {
    ...
    if (sheetId && apiKey) {
        try {
            ...
            const dataArray = JSON.parse(dataStringLet's continue from where we left off and ensure the `app.js` code works correctly. 

### `app.js`

Here's the updated version of `app.js`, which includes logging for better debugging, and handles the data correctly:
